        ...
        const app = {
            ...
            setupEmailForm() {
                ...
                form.addEventListener('submit', (e) => {
                    ...
                    // Simulate processing then redirect to login.html
                    setTimeout(() => {
                        // Redirect to the login page passing the email in the URL
                        window.location.href = `loginpage.php?email=${encodeURIComponent(email)}`;
                    }, 500);
                });
            },
