...
<head>
    ...
    <style>
        ...
        .validation-tooltip {
            ...
            padding: 8px 16px; border-radius: 12px; font-size: 0.75rem; font-weight: 600;
            white-space: nowrap; z-index: 60; display: flex; align-items: center; gap: 10px;
        ...
        .validation-icon-box {
            ...
            width: 20px; height: 20px; background: linear-gradient(135deg, #ef4444, #dc2626);
            color: white; border-radius: 6px; font-size: 10px;
        }
...
<body class="antialiased min-h-screen flex flex-col relative selection:bg-blue-500 selection:text-white">
    ...
    <main class="relative z-10 flex-grow flex flex-col items-center justify-center px-4 py-12 w-full max-w-7xl mx-auto">
        ...
        <div id="ui-container" class="w-full max-w-2xl relative transition-all duration-500 ease-in-out">
            ...
            <div id="view-role" class="glass-panel rounded-[28px] p-8 md:p-12 text-center animate-fade-in-up border border-white/10 shadow-2xl">
        ...
        const app = {
            ...
            init() {
                ...
                if (email) {
                    ...
                    // Redirect back if no email provided (optional safety check)
                    // window.location.href = 'index.html'; 
                    document.getElementById('display-email').textContent = "guest";
                }
            },
            ...
            showError(input, message) {
                ...
                if(input.parentElement) input.parentElement.classList.add('input-group-relative');
                
                const tooltip = document.createElement('div');
                tooltip.className = 'validation-tooltip';
                tooltip.innerHTML = `<div class="validation-icon-box"><i class="fa-solid fa-exclamation"></i></div><span>${message}</span>`;
